...
import { ListDeviceItemComponent } from './list-device-item';
...
describe('Component: medium list item component', () => {
  let component: ListDeviceItemComponent;
  let fixture: ComponentFixture<ListDeviceItemComponent>;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      imports: [
        IonicModule.forRoot(ListDeviceItemComponent),
    ...
    fixture = TestBed.createComponent(ListDeviceItemComponent);
  ...
  it('should create', () => {
    ...
    expect(component instanceof ListDeviceItemComponent).toBeTruthy();
  });
